...
class ContextUnet(nn.Module):
    def __init__(self, in_channels, n_feat=128, n_cfeat=10, height=128):  # adjusted for 64x64
...
# Clip values to [-1, 1] for stability
camels_data = np.clip(camels_data, -1, 1)
...
camels_data_resized = F.interpolate(camels_data_tensor, size=(128, 128), mode='bilinear')  # Resize to [128, 128]
...
selected_images_resized = F.interpolate(selected_images, size=(128, 128), mode='bilinear')
