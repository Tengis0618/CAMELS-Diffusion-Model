...
plt.subplot(2, 2, 1)
plt.plot(range(1, n_epoch+1), np.log(loss_log), color='orange', label='Training Loss', linewidth=2)
plt.plot(eval_x, np.log(val_loss_log), 'o-', color='blue', label='Validation Loss', linewidth=2, markersize=6)
plt.xlabel("Epoch", fontsize=14)
plt.ylabel("Log Loss", fontsize=14)
plt.legend(fontsize=16)
plt.grid(True, alpha=0.7)
plt.title(f"Training Metrics", fontsize=18, fontweight='bold')

# Plot 2: Negative log likelihood (both training and validation)
plt.subplot(2, 2, 2)
plt.plot(eval_x, likelihood_log, 'o-', color='orange', label='Training NLL', linewidth=2, markersize=6)
plt.plot(eval_x, val_likelihood_log, 'o-', color='blue', label='Validation NLL', linewidth=2, markersize=6)
plt.xlabel("Epoch", fontsize=14)
plt.ylabel("NLL", fontsize=14)
plt.legend(fontsize=16)
plt.grid(True, alpha=0.7)
plt.title("Negative Log Likelihood Evolution", fontsize=18, fontweight='bold')

# Plot 3: ELBO
plt.subplot(2, 2, 3)
plt.plot(eval_x, elbo_log, color='orange', label='Training ELBO', linewidth=2)
plt.plot(eval_x, val_elbo_log, 'o-', color='blue', label='Validation ELBO', linewidth=2, markersize=6)
plt.xlabel("Epoch", fontsize=14)
plt.ylabel("ELBO", fontsize=14)
plt.legend(fontsize=16)
plt.grid(True, alpha=0.7)
plt.title("ELBO Evolution", fontsize=18, fontweight='bold')

# Plot 4: BPD
plt.subplot(2, 2, 4)
plt.plot(eval_x, bpd_log, color='orange', label='Training BPD', linewidth=2)
plt.plot(eval_x, val_bpd_log, 'o-', color='blue', label='Validation BPD', linewidth=2, markersize=6)
plt.xlabel("Epoch", fontsize=14)
plt.ylabel("Bits Per Dimension (BPD)", fontsize=14)
plt.legend(fontsize=16)
plt.grid(True, alpha=0.7)
plt.title("BPD Evolution", fontsize=18, fontweight='bold')
...
def compare_distributions(camels_images, diffusion_images, output_dir):
    ...
    # Add overall title
    fig.suptitle("Probability Distribution", fontsize=18, fontweight='bold')
    plt.tight_layout()
